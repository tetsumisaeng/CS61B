                    ...
                    if (t != null) {
                        for (int k = j + 1; k < board.size(); k++) {
                            if (board.tile(i, k) == null) {
                                if (k == board.size() - 1 || (board.tile(i, k + 1) != null && (board.tile(i, k + 1).value() != t.value() || merged[i][k + 1] == true))) {
                                    merged[i][k] = board.move(i, k, t);
                                    changed = true;
                                    break;
                                }
                                continue;
                            } else if (board.tile(i, k).value() == t.value()) {
                                merged[i][k] = board.move(i, k, t);
